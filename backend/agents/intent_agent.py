...
class IntentAgent:
    ...
    def _rule_parse(self, text: str) -> ParsedIntent:
        ...
        if any(k in text for k in ("烟雾", "smoke", "告警")):
        ...
        if "普通任务" in text and "云端" in text and "烟雾" in text:
